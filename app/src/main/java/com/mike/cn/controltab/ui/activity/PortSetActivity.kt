...
class PortSetActivity : BaseActivity(), View.OnClickListener {
    ...
    override fun initView() {
        ...
        butFindWifi = findViewById(R.id.but_find_wifi)
        butSave?.setOnClickListener(this)
        ivBack?.setOnClickListener(this)
        butFindWifi?.setOnClickListener(this)
    }
    ...
    override fun onClick(v: View?) {
        when (v?.id) {
            ...
            R.id.but_find_wifi -> {
                val inn = Intent(context, FindIpActivity::class.java)
                startActivity(inn)
            }
